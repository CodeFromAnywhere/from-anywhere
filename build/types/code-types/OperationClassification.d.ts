export declare const operationClassificationConst: readonly ["cjs", "ts", "esm", "node-cjs", "node-cjs-sdk", "node-esm", "node-ts", "server-cjs", "ui-web", "ui-app", "ui-ts", "ui-cjs", "ui-esm"];
/**
