...
export const waitForDotLockRecursive = async (lockfilePath) => {
    if (fs.existsSync(lockfilePath)) {
        ...
        console.log("Warning: lockfile exists more than ten seconds. I'm assuming the operation failed (maybe server stopped during)", lockfilePath);
    }
    await writeStringToFile(lockfilePath, String(Date.now()));
    return true;
};
//# sourceMappingURL=waitForDotLockRecursive.js.map