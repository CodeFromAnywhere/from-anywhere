 ...
 */
export const pathArrayIsOperation = (pathArray) => {
    const hasPackageJson = !!pathArray.find((x) => path.parse(x).base === "package.json");
    const hasTsConfig = !!pathArray.find((x) => path.parse(x).base === "tsconfig.json");
